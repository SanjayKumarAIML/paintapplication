...
<p style="color: white; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;" >Developed By SANJAY KUMAR S S</p>
<style>
...
#air{
    background-color: #f50360;
    border: 2px solid rgb(17, 196, 228);
    border-radius: 25px;
    color: white;
    padding: 15px 32px;
    text-align: center;
